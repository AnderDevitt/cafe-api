...
RSpec.describe "/shifts", type: :request do
  ...
  before(:each) do
    employee = FactoryBot.create(:employee, first_name: "user", last_name: "user", username: "what the ufsefsdfc", is_active: true, email:"fake@email.com", is_admin: false, password: "123")
    FactoryBot.create(:shift, date: "2022-07-27", start: "2000-01-01T06:30:00.000Z", finish: "2000-01-01T12:30:00.000Z", employee_id: employee.id)
    FactoryBot.create(:shift, date: "2022-07-28", start: "2000-01-01T09:30:00.000Z", finish: "2000-01-01T14:30:00.000Z", employee_id: employee.id)
  end  
  ...
  let(:valid_attributes) {
    {
      ...
      employee_id: FactoryBot.create(:employee, first_name: "user", last_name: "user", username: "sdfsdfds", is_active: true, email:"fake@email.com", is_admin: false, password: "123").id

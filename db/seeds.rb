...
if Shift.count == 0
    ...
    s5 = Shift.create("date"=>"2022-07-27", "start"=>"06:30:00", "finish"=>"10:30:00", "employee_id" => "3")
    s6 = Shift.create("date"=>"2022-07-27", "start"=>"10:30:00", "finish"=>"12:30:00", "employee_id" => "4")
end
